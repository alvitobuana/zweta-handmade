                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="model" required 
                                    ...
                                    <option value="Tote Bag" @selected(old('model') == 'Tote Bag')>Tote Bag</option>
                                    ...
                                    <option value="Pouch" @selected(old('model') == 'Pouch')>Pouch</option>
                                    <option value="Mini Bag" @selected(old('model') == 'Mini Bag')>Mini Bag</option>
                                </select>
                                @error('model')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
